export const ROLE_CAPABILITY_MATRIX: Readonly<{
    ...
    platformRoles: Readonly<{
        platform_admin: readonly ("platform.tenant_list" | "platform.tenant_read" | "platform.tenant_create" | "platform.tenant_update" | "platform.tenant_suspend" | "platform.tenant_restore" | "platform.tenant_archive" | "platform.identity_read" | "platform.authority_revoke")[];
    }>;
}>;
